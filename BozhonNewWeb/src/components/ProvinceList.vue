            ...
            <div>
                <el-breadcrumb separator-class="el-icon-arrow-right">
                    ...
                    <el-breadcrumb-item>地区管理</el-breadcrumb-item>
                     <el-breadcrumb-item>一级城市</el-breadcrumb-item>
    ...
    <el-row>
        ...
        <el-col :span="22">
            <el-table ref="multipleTable" :data="listdata" tooltip-effect="dark" style="width: 100%" border height="350" :default-sort="{prop:'uId'}" v-loading="loading">
                ...
                <el-table-column prop="provinceId" label="ID" width="465" sortable></el-table-column>
                <el-table-column prop="provinceName" label="一级城市" width="470"></el-table-column>
            </el-table>
        </el-col>
    </el-row>
    <el-row>
